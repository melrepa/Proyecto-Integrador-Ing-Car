...
<script type='text/javascript'>                    
  var divElement = document.getElementById('viz1669872778800');                    
  var vizElement = divElement.getElementsByTagName('object')[0];                    
  if ( divElement.offsetWidth > 800 ) { vizElement.style.width='1300px';vizElement.style.height='3087px';} else if ( divElement.offsetWidth > 500 ) { vizElement.style.width='1300px';vizElement.style.height='3087px';} else { vizElement.style.width='100%';vizElement.style.height='3777px';}                     
